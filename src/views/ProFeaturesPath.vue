  ...
  <div class="workshop-path">
    <div class="path-header">
      <div class="path-info">
        ...
        <h1 class="path-title">Copilot Pro Features</h1>
        <p class="path-description">
          Explore advanced GitHub Copilot capabilities for professional development.
        </p>
      </div>
...
export default {
  ...
  data() {
    return {
      steps: proFeaturesSteps,
      pathName: 'pro-features'
    }
  },
  computed: {
